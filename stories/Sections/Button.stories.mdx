...
<Meta title="Chatwoot/Buttons" />

# Buttons

The buttons in chatwoot can be added with `woot-button`. The button component is made on top of [foundation button](https://get.foundation/sites/docs/button.html)
