...
const hsResizeObserverDummyAnimation = theming.keyframes`0%{z-index:0}to{z-index:-1}`;
...
const GlobalScrollAreaStyles = () => React__default["default"].createElement(theming.Global, {
  styles: getScrollAreaStyles
});

exports["default"] = GlobalScrollAreaStyles;
