...
describe(__1.default, function () {
    test('starts out empty', function () {
        var stats = new __1.default();
        expect(stats.metrics).toEqual([]);
    });
    test('records increments', function () {
        var stats = new __1.default();
        stats.increment('m1');
    ...
    test('serializes metrics to a more compact format', function () {
        var stats = new __1.default();
    ...
    test('flushes metrics', function () {
        jest.spyOn(console, 'table').mockImplementationOnce(function () { });
        var stats = new __1.default();
        stats.gauge('some_gauge', 31, ['test:env']);
        stats.increment('some_increment', 22, ['test:env']);
        stats.flush();
    ...
    test('forwards increments to remote metrics endpoint', function () {
        var remote = new remote_metrics_1.RemoteMetrics();
        var spy = jest.spyOn(remote, 'increment');
        var stats = new __1.default(remote);
