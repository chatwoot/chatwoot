...
describe(__1.resolveArguments, function () {
    test('resolves all args', function () {
        var callback = jest.fn();
        var _a = __1.resolveArguments('Test Event', bananaPhone, {
            integrations: {
                amplitude: false,
            },
    ...
    describe('event as string', function () {
        test('event, props', function () {
            var _a = __1.resolveArguments('Test Event', bananaPhone), event = _a[0], props = _a[1], options = _a[2], cb = _a[3];
            expect(event).toEqual('Test Event');
            expect(props).toEqual(bananaPhone);
            expect(options).toEqual({});
        ...
        test('event, props, callback', function () {
            var fn = jest.fn();
            var _a = __1.resolveArguments('Test Event', bananaPhone, fn), event = _a[0], props = _a[1], options = _a[2], cb = _a[3];
            expect(event).toEqual('Test Event');
            expect(props).toEqual(bananaPhone);
            expect(options).toEqual({});
        ...
        test('event, callback', function () {
            var fn = jest.fn();
            var _a = __1.resolveArguments('Test Event', fn), event = _a[0], props = _a[1], options = _a[2], cb = _a[3];
            expect(event).toEqual('Test Event');
...
describe(__1.resolvePageArguments, function () {
    test('should accept (category, name, properties, options, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments('category', 'name', bananaPhone, baseOptions, fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
    ...
    test('empty strings ("", "", "", { integrations })', function () {
        var _a = __1.resolvePageArguments('', '', null, {
            integrations: {
                Amplitude: {
                    sessionId: '123',
                },
    ...
    test('should accept (category, name, properties, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments('category', 'name', bananaPhone, fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
        expect(category).toEqual('category');
        expect(name).toEqual('name');
        expect(properties).toEqual(bananaPhone);
        expect(cb).toEqual(fn);
    ...
    it('should accept (category, name, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments('category', 'name', fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
        expect(category).toEqual('category');
        expect(name).toEqual('name');
        expect(properties).toEqual({});
        expect(cb).toEqual(fn);
    ...
    it('should accept (name, properties, options, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments('name', bananaPhone, baseOptions, fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
    ...
    it('should accept (name, properties, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments('name', bananaPhone, fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
        expect(category).toEqual(null);
        expect(name).toEqual('name');
        expect(properties).toEqual(bananaPhone);
        expect(cb).toEqual(fn);
    ...
    it('should accept (name, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments('name', fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
        expect(name).toEqual('name');
        expect(cb).toEqual(fn);
        expect(category).toEqual(null);
        expect(properties).toEqual({});
    ...
    it('should accept (properties, options, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments(bananaPhone, baseOptions, fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
        expect(cb).toEqual(fn);
        expect(properties).toEqual(bananaPhone);
        expect(options).toEqual(baseOptions);
    ...
    it('should accept (properties, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolvePageArguments(bananaPhone, fn), category = _a[0], name = _a[1], properties = _a[2], options = _a[3], cb = _a[4];
        expect(properties).toEqual(bananaPhone);
        expect(cb).toEqual(fn);
        expect(options).toEqual({});
        expect(name).toEqual(null);
...
describe(__1.resolveUserArguments, function () {
    var user;
    var resolver;
    var fn;
    var userTraits = {
    ...
    beforeEach(function () {
        ...
        resolver = __1.resolveUserArguments(user);
        fn = jest.fn();
    });
...
describe(__1.resolveAliasArguments, function () {
    it('should accept (to, from, options, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolveAliasArguments('to', 'from', {
            integrations: {
                intercom: false,
            },
    ...
    it('should accept (to, options, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolveAliasArguments('to', {
            integrations: {
                intercom: false,
            },
        }, fn), to = _a[0], from = _a[1], options = _a[2], cb = _a[3];
    ...
    it('should accept (to, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolveAliasArguments('to', fn), to = _a[0], from = _a[1], options = _a[2], cb = _a[3];
        expect(to).toEqual('to');
        expect(from).toBeNull();
        expect(options).toEqual({});
        expect(cb).toBe(fn);
    ...
    it('should accept (to, from, callback)', function () {
        var fn = jest.fn();
        var _a = __1.resolveAliasArguments('to', 'from', fn), to = _a[0], from = _a[1], options = _a[2], cb = _a[3];
        expect(to).toEqual('to');
        expect(from).toEqual('from');
        expect(options).toEqual({});
        expect(cb).toBe(fn);
