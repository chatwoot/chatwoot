...
var EventFactory = /** @class */ (function () {
    ...
    EventFactory.prototype.identify = function (userId, traits, options, globalIntegrations) {
        return this.normalize(tslib_1.__assign(tslib_1.__assign({}, this.baseEvent()), { type: 'identify', userId: userId,
            traits: traits, options: tslib_1.__assign({}, options), integrations: tslib_1.__assign({}, globalIntegrations) }));
    };
    ...
    EventFactory.prototype.context = function (event) {
        ...
        providedOptionsKeys.forEach(function (key) {
            ...
            if (optionsKeys.includes(key)) {
                dset_1.dset(overrides, key, options[key]);
            }
            else {
                dset_1.dset(context, key, options[key]);
            }
        });
    ...
    EventFactory.prototype.normalize = function (event) {
        ...
        var body = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, rest), { context: context, integrations: allIntegrations }), overrides);
        var messageId = 'ajs-next-' + spark_md5_1.default.hash(JSON.stringify(body) + uuid_1.v4());
