...
var uuid_1 = tslib_1.__importDefault(require("@lukeed/uuid"));
...
describe('Event Factory', function () {
    ...
    beforeEach(function () {
        ...
        user.reset();
        factory = new __1.EventFactory(user);
    });
    ...
    describe('track', function () {
        ...
        test('adds a random message id even when random is mocked', function () {
            jest.useFakeTimers();
            jest.spyOn(uuid_1.default, 'v4').mockImplementation(function () { return 'abc-123'; });
        ...
        test('message ids are random', function () {
            var ids = lodash_1.range(0, 200).map(function () { return factory.track('Order Completed', shoes).messageId; });
            expect(lodash_1.uniq(ids)).toHaveLength(200);
        });
