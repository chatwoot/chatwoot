...
function link(links, event, properties) {
    var _this = this;
    var elements = [];
    ...
    elements.forEach(function (el) {
        el.addEventListener('click', function (elementEvent) {
            ...
            var href = el.getAttribute('href') ||
                ...
                el.getAttribute('xlink:href') || ((_a = el.getElementsByTagName('a')[0]) === null || _a === void 0 ? void 0 : _a.getAttribute('href'));
            var trackEvent = callback_1.pTimeout(_this.track(ev, props), (_b = _this.settings.timeout) !== null && _b !== void 0 ? _b : 500);
...
exports.link = link;
function form(forms, event, properties) {
    var _this = this;
    // always arrays, handles jquery
    if (!forms)
        return this;
    ...
    elements.forEach(function (el) {
        ...
        var handler = function (elementEvent) {
            ...
            var ev = event instanceof Function ? event(el) : event;
            var props = properties instanceof Function ? properties(el) : properties;
            var trackEvent = callback_1.pTimeout(_this.track(ev, props), (_a = _this.settings.timeout) !== null && _a !== void 0 ? _a : 500);
            trackEvent
                .catch(console.error)
                .then(function () {
                el.submit();
