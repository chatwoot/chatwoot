...
describe('CSP Detection', function () {
    ...
    beforeEach(function () {
        ...
        var html = ("\n    <!DOCTYPE html>\n      <head>\n        <script>\n          " + segment_snippet_1.snippet(writeKey, true) + "\n        </script>\n      </head>\n      <body>\n      </body>\n    </html>\n    ").trim();
    ...
    it('reverts to ajs classic in case of CSP errors', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var handlers;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, p_while_1.pWhile(function () { return getClassic() === undefined; }, function () { })];
                case 2:
                    _a.sent();
    ...
    it('does not revert to classic when CSP error is report only', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, csp_detection_1.onCSPError({
                            blockedURI: 'cdn.segment.com',
                            disposition: 'report',
                        })];
                case 1:
