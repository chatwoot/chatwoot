...
function post(event, writeKey) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_fetch_1.default("https://api.june.so/sdk/" + event.type, {
                        method: 'POST',
                        body: JSON.stringify(tslib_1.__assign(tslib_1.__assign({}, event), { writeKey: writeKey })),
