...
var Analytics = /** @class */ (function (_super) {
    ...
    function Analytics(settings, options, queue, user, group) {
        ...
        _this.queue = queue !== null && queue !== void 0 ? queue : new event_queue_1.EventQueue(new persisted_1.PersistedPriorityQueue((options === null || options === void 0 ? void 0 : options.retryQueue) ? 4 : 1, 'event-queue'));
        _this._user = user !== null && user !== void 0 ? user : new user_1.User(options === null || options === void 0 ? void 0 : options.user, cookieOptions).load();
        _this._group = group !== null && group !== void 0 ? group : new user_1.Group(options === null || options === void 0 ? void 0 : options.group, cookieOptions).load();
    ...
    Analytics.prototype.identify = function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                _a = arguments_resolver_1.resolveUserArguments(this._user).apply(void 0, args), id = _a[0], _traits = _a[1], options = _a[2], callback = _a[3];
    ...
    Analytics.prototype.group = function () {
        ...
        var _a = arguments_resolver_1.resolveUserArguments(this._group).apply(void 0, args), id = _a[0], _traits = _a[1], options = _a[2], callback = _a[3];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        autotrack = _b.sent();
                        return [2 /*return*/, (_a = autotrack.link).call.apply(_a, tslib_1.__spreadArrays([this], args))];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        autotrack = _b.sent();
                        return [2 /*return*/, (_a = autotrack.form).call.apply(_a, tslib_1.__spreadArrays([this], args))];
                }
            });
        });
    };
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (connection_1.isOffline() && !this.options.retryQueue) {
                            return [2 /*return*/, ctx];
                        }
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, callback_1.invokeCallback(dispatched, callback, this.settings.timeout)];
                    case 5:
                        dispatched = _a.sent();
                        _a.label = 6;
                    case 6:
