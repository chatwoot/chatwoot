    ...
    var stub = {
        ...
        page: function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, page.evaluate(function (innerArgs) { return __awaiter(_this, void 0, void 0, function () {
                                var _a;
...
export var getBrowser = mem(function (browserType, remoteDebug) { return __awaiter(void 0, void 0, void 0, function () {
    var browser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, playwright[browserType !== null && browserType !== void 0 ? browserType : 'chromium'].launch({
                    headless: true,
                    devtools: true,
                    args: [
                        '--no-sandbox',
...
export function testerTeardown() {
    return __awaiter(this, void 0, void 0, function () {
        var browser;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function tester(_writeKey, url, browserType, remoteDebug) {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getBrowser(browserType, remoteDebug)];
                case 1:
                    browser = _a.sent();
