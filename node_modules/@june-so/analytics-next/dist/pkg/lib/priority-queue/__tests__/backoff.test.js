...
describe('backoff', function () {
    ...
    it('accepts a growth factor', function () {
        var f2 = backoff({ attempt: 2, factor: 2 });
        var f3 = backoff({ attempt: 2, factor: 3 });
