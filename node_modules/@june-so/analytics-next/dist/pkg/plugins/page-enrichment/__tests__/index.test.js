...
describe('Page Enrichment', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ajs.register(pageEnrichment)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('enriches page calls', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ctx;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    test('enriches track events with the page context', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ctx;
        var _a;
    ...
    test('enriches page events with the page context', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ctx;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
    ...
    test('enriches page events using properties', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ctx;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
    ...
    test('enriches identify events with the page context', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ctx;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
    ...
    test('runs before any other plugin', function () { return __awaiter(void 0, void 0, void 0, function () {
        var called;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
