...
def main():
    ...
    run_cmd("Preparing Chatwoot DB", 
        "docker compose -f docker-compose.build.yaml run --rm rails bundle exec rails db:chatwoot_prepare")

    #run_cmd("Seeding Database", 
        #"docker compose -f docker-compose.build.yaml run --rm rails bundle exec rails db:seed")
