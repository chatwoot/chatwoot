...
attr_accessor :conversations, :file_name

  def initialize(conversations, file_name)
  ...
  def arrow_fields
    [
      ...
      Arrow::Field.new('snoozed_until', :int32),
      Arrow::Field.new('status', :string),
      Arrow::Field.new('closed', :boolean),
      Arrow::Field.new('created_at', :int32),
      Arrow::Field.new('timestamp', :int32),
      Arrow::Field.new('first_reply_created_at', :int32),
      Arrow::Field.new('unread_count', :int32),
      Arrow::Field.new('last_non_activity_message', :string),
      Arrow::Field.new('last_activity_at', :int32),
  ...
  def map_columns_array
    [
      ...
      Arrow::Int32Array.new(@columns['sender_id']),
      ...
      Arrow::Int32Array.new(@columns['contact_last_seen_at']),
      ...
      Arrow::Int32Array.new(@columns['snoozed_until']),
      Arrow::StringArray.new(@columns['status']),
      Arrow::BooleanArray.new(@columns['closed']),
      Arrow::Int32Array.new(@columns['created_at']),
      Arrow::Int32Array.new(@columns['timestamp']),
      Arrow::Int32Array.new(@columns['first_reply_created_at']),
      Arrow::Int32Array.new(@columns['unread_count']),
      Arrow::StringArray.new(@columns['last_non_activity_message']),
      Arrow::Int32Array.new(@columns['last_activity_at']),
