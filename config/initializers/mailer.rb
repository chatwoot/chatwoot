Rails.application.configure do
  ...
  smtp_settings[:open_timeout] = ENV.fetch('SMTP_OPEN_TIMEOUT') if ENV.fetch('SMTP_OPEN_TIMEOUT').present?
  smtp_settings[:read_timeout] = ENV.fetch('SMTP_READ_TIMEOUT') if ENV.fetch('SMTP_READ_TIMEOUT').present?
