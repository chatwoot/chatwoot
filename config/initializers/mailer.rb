Rails.application.configure do
  ...
  smtp_settings[:open_timeout] = ENV['SMTP_OPEN_TIMEOUT'] if ENV['SMTP_OPEN_TIMEOUT'].present?
  smtp_settings[:read_timeout] = ENV['SMTP_READ_TIMEOUT'] if ENV['SMTP_READ_TIMEOUT'].present?
