...
| **P5 — Pet** | Tauri app + widget pet-mode | 🔶 **مرحله ۱ انجام شد (2026-08-24):** `apps/pet/` — Tauri app scaffold با transparent always-on-top window، Pawly SVG blob با gradient/whiskers/ears، drag support، notification badge، context menu (Open Dashboard/Sound/Quit)، random idle bounce. *باقیمانده: اتصال به Whisker API برای notification polling، Windows/macOS/Linux build، system tray integration* |
