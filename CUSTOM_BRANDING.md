...
Update the favicon files in the `public/` folder.

Can also be done by creating a zip file with relevant files, and running `deployment/extract_brand_assets.sh` to override the existing favicons with your own.
