...
export const colors = {
  // Stitch: "Design Tokens & Typography" (Cybros)
  // Keep semantic color names so utility classes can match the design spec directly.
  'secondary-container': '#06be99',
  'on-error': '#690005',
  'surface-bright': '#2c3a4e',
  'on-surface': '#d5e3fe',
  'surface-container-low': '#0d1c2f',
  'on-primary-fixed-variant': '#3a475d',
  'inverse-primary': '#515f75',
  'primary-fixed': '#d5e3fe',
  'on-secondary-container': '#004637',
  'surface-container-high': '#1d2b3e',
  'tertiary-container': '#00173c',
  ...
  'surface-container-lowest': '#010e21',
  'on-primary-container': '#74829a',
  'secondary-fixed': '#69fad2',
  'outline-variant': '#44474c',
  'on-secondary-fixed-variant': '#005140',
  'on-primary': '#233145',
  'on-tertiary-container': '#367ef2',
  'on-tertiary': '#002e6a',
  background: '#051427',
  'surface-dim': '#051427',
  error: '#ffb4ab',
  ...
  'inverse-surface': '#d5e3fe',
  'error-container': '#93000a',
  'surface-container-highest': '#28354a',
  'primary-container': '#0a192c',
  'tertiary-fixed': '#d8e2ff',
  'surface-container': '#122033',
  'primary-fixed-dim': '#b9c7e1',
  'on-primary-fixed': '#0d1c2f',
  'surface-variant': '#28354a',
  'secondary-fixed-dim': '#46ddb7',
  'on-background': '#d5e3fe',
  outline: '#8e9097',
