user = User.find_or_initialize_by(email: 'admin@heycommerce.com')
user.password = 'Admin@123456'
user.password_confirmation = 'Admin@123456'
user.name = 'Admin HeyCommerce'
user.confirmed_at = Time.now
user.save!

account = Account.find_or_create_by!(name: 'HeyCommerce')
...
puts 'Email: admin@heycommerce.com'
