    ...
    class << self
      sig do
        params(
          ...
          include_financial_summaries: T.untyped,
          include_order_reference_fields: T.untyped,
          session: Auth::Session
        ).returns(T.nilable(FulfillmentOrder))
      end
      def find(
        id:,
        include_financial_summaries: nil,
        include_order_reference_fields: nil,
      ...
      def all(
        ...
        **kwargs
        ...
        response = base_find(
          ...
          params: {include_financial_summaries: include_financial_summaries, include_order_reference_fields: include_order_reference_fields}.merge(kwargs).compact,
        )
