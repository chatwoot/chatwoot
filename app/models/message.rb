...
class Message < ApplicationRecord
  ...
  store :content_attributes, accessors: [:submitted_email, :items, :submitted_values, :email, :in_reply_to, :comment_id, :deleted,
                                         ...
                                         :reply_to_comment_id, :is_dm_conversation_created, :user_phone_number, :previous_selected_replies, :user_order_id, :selected_reply, :product_id, :product_id_for_more_info, :assign_to_agent, :conversation_resolved], coder: JSON
