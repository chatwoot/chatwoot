...
class Message < ApplicationRecord
  ...
  after_create_commit :debug_callback_triggered
  after_create_commit :debug_all_messages
  ...
  def debug_all_messages
    Rails.logger.info "=== MESSAGE CREATED DEBUG ==="
    Rails.logger.info "Message ID: #{id}"
    Rails.logger.info "Content: #{content}"
    Rails.logger.info "Private: #{private?}"
    Rails.logger.info "Outgoing: #{outgoing?}"
  ...
  # Notification forward helpere methods
