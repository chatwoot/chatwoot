...
class Message < ApplicationRecord
  ...
  # [:external_created_at] : Used to specifiy if the message was created at a differnt time stamp externally
  store :content_attributes, accessors: [:submitted_email, :items, :submitted_values, :email, :in_reply_to, :deleted, :external_created_at], coder: JSON
