...
class Notification < ApplicationRecord
  ...
  def conversation
    return primary_actor.conversation if %w[assigned_conversation_new_message participating_conversation_new_message conversation_mention].include? notification_type
