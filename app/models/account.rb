...
class Account < ApplicationRecord
  ...
  has_many :account_email_templates, dependent: :destroy_async
  has_many :advanced_email_templates, dependent: :destroy_async
  has_many :user_assignments, through: :advanced_email_templates
