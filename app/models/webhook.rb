...
class Webhook < ApplicationRecord
  ...
  ALLOWED_WEBHOOK_EVENTS = %w[conversation_status_changed conversation_updated conversation_created conversation_deleted contact_created contact_updated contact_deleted
