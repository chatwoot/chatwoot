# SSRF guard for Captain custom tools: the endpoint URL is user-supplied and
# rendered through Liquid, so validate the resolved host before any request is
# made from the server.
module SafeEndpointValidatable
