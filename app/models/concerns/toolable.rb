# Behaviour for Captain custom tools: turns a Captain::CustomTool record into a
# live LLM tool class, and renders its endpoint URL / request body / response
# templates (Liquid) at call time.
module Toolable
