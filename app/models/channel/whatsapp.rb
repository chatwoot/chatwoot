...
class Channel::Whatsapp < ApplicationRecord
  ...
  PROVIDERS = %w[default whatsapp_cloud 360dialog_cloud].freeze
  ...
  def provider_service
    ...
    elsif provider == '360dialog_cloud'
      Whatsapp::Providers::Whatsapp360DialogCloudService.new(whatsapp_channel: self)
    else
