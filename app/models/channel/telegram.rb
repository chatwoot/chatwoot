...
class Channel::Telegram < ApplicationRecord
  ...
  def send_message_on_telegram(message)
    message_id = send_message(message) if message.content_for_channel.present?
  ...
  def send_message(message)
    response = message_request(chat_id(message), message.content_for_channel, reply_markup(message), reply_to_message_id(message))
