...
class Channel::Telegram < ApplicationRecord
  ...
  def send_message_on_telegram(message)
    message_id = send_message(message) if message.channel_content.present?
  ...
  def send_message(message)
    response = message_request(chat_id(message), message.channel_content, reply_markup(message), reply_to_message_id(message))
