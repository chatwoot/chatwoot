class Api::V1::Accounts::Conversations::MessagesController < Api::V1::Accounts::Conversations::BaseController
  ...
  def claim_message_retry
    message.with_lock do
      ...
      # Only the failure itself is reset. The reply context, email recipients, translations and any
      # attributes an integration stored must survive: the retried send is built from them.
      retry_attributes = { content_attributes: message.content_attributes.except('external_error') }
