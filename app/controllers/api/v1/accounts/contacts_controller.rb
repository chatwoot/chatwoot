class Api::V1::Accounts::ContactsController < Api::V1::Accounts::BaseController
  ...
  def permitted_params
    params.permit(:name, :identifier, :email, :phone_number, :stage_id, :avatar, :blocked, :assignee_id_in_leads, :team_id,
                  :avatar_url, additional_attributes: {}, custom_attributes: {})
  end
