class Api::V1::Accounts::AgentsController < Api::V1::Accounts::BaseController
  ...
  def create
    builder = AgentBuilder.new(
      ...
      confirmed_at: new_agent_params['confirmed_at'],
  ...
  def allowed_agent_params
    [:name, :email, :role, :availability, :auto_offline, :password, :confirmed_at]
  end
  ...
  def new_agent_params
    params.require(:agent).permit(:email, :name, :role, :availability, :auto_offline, :password, :confirmed_at)
  end
