class Api::V1::Accounts::ConversationsController < Api::V1::Accounts::BaseController
  ...
  def update_last_seen
    ...
    return update_last_seen_on_conversation(DateTime.now.utc, true) if assignee? && @conversation.assignee_unread_incoming_messages?
    return update_last_seen_on_conversation(DateTime.now.utc, false) if !assignee? && @conversation.unread_incoming_messages?
