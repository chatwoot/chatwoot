class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  CAPTAIN_APP_CONFIG_KEYS = %w[
    CAPTAIN_OPEN_AI_API_KEY CAPTAIN_OPEN_AI_MODEL CAPTAIN_PDF_PROCESSING_MODEL CAPTAIN_OPEN_AI_ENDPOINT
    CAPTAIN_EMBEDDING_MODEL CAPTAIN_EMBEDDING_DIMENSIONS CAPTAIN_LLM_PROVIDER CAPTAIN_FIRECRAWL_API_KEY
  ...
  def allowed_configs
    mapping = {
      ...
      'captain' => CAPTAIN_APP_CONFIG_KEYS
    }
