class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'aloo' => %w[
        ALOO_ENABLED
        ALOO_OPENAI_API_KEY ALOO_ANTHROPIC_API_KEY ALOO_GEMINI_API_KEY ALOO_DEEPSEEK_API_KEY
        ALOO_DEFAULT_MODEL ALOO_EMBEDDING_MODEL ALOO_DEFAULT_TEMPERATURE ALOO_MAX_TOKENS
        ALOO_FEATURE_FAQ ALOO_FEATURE_MEMORY ALOO_FEATURE_VISION
