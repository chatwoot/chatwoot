class OauthCallbackController < ApplicationController
  ...
  def handle_response
    ...
    if already_exists
      redirect_to app_inbox_wizard_settings_url(account_id: account.id, inbox_id: inbox.id)
    else
      redirect_to app_inbox_wizard_agents_url(account_id: account.id, inbox_id: inbox.id)
    end
  end
