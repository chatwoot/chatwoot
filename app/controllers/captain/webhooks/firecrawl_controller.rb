...
# Receives FireCrawl crawl callbacks for Captain document indexing.
# Mounted at POST /webhooks/captain/firecrawl (see config/routes.rb).
class Captain::Webhooks::FirecrawlController < ActionController::API
