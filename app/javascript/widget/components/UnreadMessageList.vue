    ...
    <div class="open-read-view-wrap">
      ...
      >
        <span
          ...
          :class="{
            '!text-s-primary': isBackgroundLighter,
          }"
          :style="{
            color: widgetColor,
          }"
...
.unread-wrap {
  ...
  .clear-button {
    ...
    @apply bg-transparent text-s-brand border-none border-0 font-semibold text-base ml-1 py-0 pl-0 pr-2.5 hover:brightness-75 hover:translate-x-1;
  }

  .close-unread-button {
    transition: all 0.3s cubic-bezier(0.17, 0.67, 0.83, 0.67);
    @apply bg-s-subtle dark:bg-s-primary text-s-primary dark:text-s-inverse hover:brightness-95 border-none border-0 font-medium text-xxs rounded-2xl mb-3;
  }
}
</style>
