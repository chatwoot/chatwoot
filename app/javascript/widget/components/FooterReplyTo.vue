...
<template>
  <div
    class="mb-2.5 rounded-[7px] bg-s-subtle px-2 py-1.5 text-sm text-s-muted flex items-center gap-2"
  >
    ...
    <button
      class="items-end flex-shrink-0 p-1 rounded-md hover:bg-s-border-subtle"
      @click="$emit('dismiss')"
    >
