...
<template>
  ...
  >
    <a
      ...
      target="_blank"
      class="branding--link text-s-muted hover:text-s-primary cursor-pointer text-xs inline-flex grayscale-[1] hover:grayscale-0 hover:opacity-100 opacity-90 no-underline justify-center items-center leading-3"
    >
      <img
