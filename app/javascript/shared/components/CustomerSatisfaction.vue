...
export default {
  ...
  computed: {
    ...
    title() {
      return this.isCSATRatingSubmitted
  ...
  methods: {
    buttonClass(rating) {
      return [
        ...
        { disabled: this.isCSATRatingSubmitted },
        { hover: this.isCSATRatingSubmitted },
        'emoji-button',
      ];
    },
    onSubmit() {
