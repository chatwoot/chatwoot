  ...
  describe('tweets', () => {
    ...
    it('should add links to @mentions', () => {
      ...
      expect(
        ...
        '<p><a href="https://twitter.com/chatwootapp" target="_blank" rel="noreferrer nofollow noopener">@chatwootapp</a> is an opensource tool thanks @longnonexistenttwitterusername</p>'
      );
    });
