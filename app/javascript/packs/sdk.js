/* eslint-disable */
(function (WOOT_ACCOUNT_ID, WOOT_INBOX_ID) {
  ...
  function createChatBubble() {
    ...
    icon_bubble.src = 'data:image/png;base64,';
  ...
  function sendContactDataToIframe() {
    var iframeEl = document.getElementById(_id);
    var data = {
  ...
  function load_css() {
    ...
    css.type = 'text/css';
    css.innerHTML = '.woot-widget-holder { z-index: 2147483000!important;'
  ...
  function classHelper(classes, action, elm) {
    let classarray; let search; let replace; let i; let
      has = false;
    if (classes) {
      // Trim any whitespace
