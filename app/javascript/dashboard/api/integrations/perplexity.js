...
/**
 * Represents the data object for a Perplexity hook.
 ...
 * @extends ApiClient
 */
class PerplexityAPI extends ApiClient {
  /**
   * Creates a new PerplexityAPI instance.
   */
  constructor() {
  ...
  /**
   * Processes an event using the Perplexity API.
...
export default new PerplexityAPI();
