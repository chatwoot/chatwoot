...
<template>
  ...
  >
    <a
      ...
      :class="[
        active
          ? 'text-secondary after:bg-secondary after:opacity-100'
          : 'text-on-surface-variant after:bg-transparent after:opacity-0 hover:text-on-surface',
      ...
      <div
        ...
        :class="[
          active
            ...
            : 'bg-n-alpha-1 text-on-surface-variant',
        ]"
      >
        <span>
          {{ getItemCount }}
