...
.is-private {
  .prosemirror-mention-node {
    @apply font-medium bg-yellow-50 dark:bg-yellow-200 text-slate-900 dark:text-slate-900 py-0 px-1;
  }

  .ProseMirror-menubar-wrapper {
    .ProseMirror-menubar {
      @apply bg-yellow-50 dark:bg-yellow-200 text-slate-700 dark:text-slate-700;
    }
