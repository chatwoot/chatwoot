  ...
  <div class="space-y-2 mb-4">
    <div class="overflow-y-auto max-h-56">
      <p
        ...
        class="text-s-brand-text text-sm prose-sm font-normal !mb-4"
      />
    </div>
    <div class="editor-root relative editor--copilot space-x-2">
      ...
      <div class="flex items-center justify-end absolute right-2 bottom-2">
        <NextButton
          class="bg-s-brand text-white !rounded-full"
...
.editor--copilot {
  ...
  .ProseMirror-woot-style {
    ...
    .empty-node {
      &::before {
        @apply text-s-brand dark:text-s-brand-text;
      }
    }
  }
}
