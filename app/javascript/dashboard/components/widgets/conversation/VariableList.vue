...
const emit = defineEmits(['selectVariable', 'close']);
...
// That text still carries the closing braces when the caret sits inside a complete variable.
...
// Only these two resolve on send: `ConversationDrop` and `ContactDrop` expose
// `custom_attribute`, company attributes have no drop at all.
