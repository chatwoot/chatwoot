...
<template>
  <div
    ref="menuRef"
    class="text-s-primary menu-with-submenu min-width-calc w-full p-1 flex items-center h-7 rounded-md relative bg-s-subtle/50 backdrop-blur-[100px] justify-between hover:bg-s-brand/10 cursor-pointer dark:hover:bg-s-subtle"
  ...
  >
    ...
    <div
      ...
      class="submenu bg-s-subtle backdrop-blur-[100px] p-1 shadow-lg rounded-md absolute hidden max-h-[15rem] overflow-y-auto overflow-x-hidden cursor-pointer"
