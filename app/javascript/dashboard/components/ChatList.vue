<template>
  <div
    class="conversations-list-wrap flex-basis-clamp flex-shrink-0 flex-basis-custom overflow-hidden flex flex-col border-r rtl:border-r-0 border-slate-50 dark:border-slate-800/50"
    :class="{
  ...
  >
    ...
    >
      <div class="flex max-w-[85%] justify-center items-center">
        <h1
          class="text-xl break-words text-black-800 dark:text-slate-100 overflow-hidden whitespace-nowrap text-ellipsis mb-0"
          :title="pageTitle"
        >
          {{ pageTitle }}
        </h1>
