<template>
  <div class="-mt-px text-sm">
    <button
      class="flex items-center select-none w-full bg-slate-50 dark:bg-slate-700 border-b border-t m-0 border-slate-100 dark:border-slate-600 cursor-grab justify-between py-2 px-4 drag-handle"
      @click="$emit('click')"
    >
