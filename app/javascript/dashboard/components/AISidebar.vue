...
const conversationList = computed(() => {
  ...
  // Filtra a lista de conversas, retornando apenas aquelas
  // cujo 'inbox_id' é igual ao ID que recebemos via prop.
  // Usamos Number() para garantir que estamos comparando números.
  return chatLists.value.filter(
    conversation => conversation.inbox_id === Number(props.inboxId)
  );
});
