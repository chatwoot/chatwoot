...
export const getters = {
  ...
  getBroadcastCampaigns: (_state, _getters) => {
    return _getters.getCampaigns(CAMPAIGN_TYPES.ONE_OFF);
  },
  getProactiveCampaigns: (_state, _getters) => {
    const proactiveChannelTypes = [INBOX_TYPES.WEB];
    return _getters.getCampaigns(CAMPAIGN_TYPES.ONGOING, proactiveChannelTypes);
  },
