...
export const actions = {
  get: async ({ commit }, conversationId) => {
    commit(types.default.SET_TICKET_LABELS_UI_FLAG, {
      isFetching: true,
    });
    try {
      const response = await ConversationAPI.getLabels(conversationId);
      commit(types.default.SET_TICKET_LABELS, {
        id: conversationId,
...
export const mutations = {
  [types.default.SET_TICKET_LABELS_UI_FLAG]($state, data) {
    $state.uiFlags = {
      ...$state.uiFlags,
      ...data,
    };
  },
  [types.default.SET_TICKET_LABELS]: ($state, { id, data }) => {
