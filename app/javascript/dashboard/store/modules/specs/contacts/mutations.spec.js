...
describe('#mutations', () => {
  ...
  describe('#BLOCK_CONTACT', () => {
    it('updates contact blocked status to true', () => {
      const state = {
        records: {
          1: {
            id: 1,
      ...
      mutations[types.BLOCK_CONTACT](state, 1);
      expect(state.records[1].blocked).toBe(true);
  ...
  describe('#UNBLOCK_CONTACT', () => {
    it('updates contact blocked status to false', () => {
      const state = {
        records: {
          1: {
            id: 1,
      ...
      mutations[types.UNBLOCK_CONTACT](state, 1);
      expect(state.records[1].blocked).toBe(false);
      expect(state.records[1]).toEqual({
        id: 1,
        name: 'contact1',
        email: 'contact1@chatwoot.com',
