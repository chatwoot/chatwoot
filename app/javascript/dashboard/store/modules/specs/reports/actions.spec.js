...
describe('#actions', () => {
  describe('#downloadAgentReports', () => {
    it('open CSV download prompt if API is success', async () => {
      ...
      const mockAgentDownloadElement = document.createElement('a');
      jest
        .spyOn(document, 'createElement')
        .mockImplementation(() => mockAgentDownloadElement);
  ...
  describe('#downloadLabelReports', () => {
    it('open CSV download prompt if API is success', async () => {
      ...
      const mockLabelDownloadElement = document.createElement('a');
      jest
        .spyOn(document, 'createElement')
        .mockImplementation(() => mockLabelDownloadElement);
  ...
  describe('#downloadInboxReports', () => {
    it('open CSV download prompt if API is success', async () => {
      ...
      const mockInboxDownloadElement = document.createElement('a');
      jest
        .spyOn(document, 'createElement')
        .mockImplementation(() => mockInboxDownloadElement);
