...
const actions = {
  async fetch(
    ...
    try {
      ...
      const { payload: orders = [], meta = {} } = response.data;
      const { count: totalEntries, current_page: currentPage } = meta;

      commit(types.default.SET_ORDERS, orders);
      commit(types.default.SET_ORDERS_META, {
        totalEntries,
        perPage: 15,
  ...
  setFilters({ commit, dispatch }, filters) {
    commit(types.default.SET_ORDERS_FILTERS, filters);
    dispatch('fetch', { page: 1 });
  },
  clearFilters({ commit, dispatch }) {
    commit(types.default.CLEAR_ORDERS_FILTERS);
    dispatch('fetch', { page: 1 });
  },
};
...
const mutations = {
  ...
  [types.default.SET_ORDERS_FILTERS](_state, filters) {
    _state.filters = {
      ..._state.filters,
      ...filters,
    };
  },
  [types.default.CLEAR_ORDERS_FILTERS](_state) {
    _state.filters = {
      status: 'all',
      dateRange: 'all',
      dateFrom: null,
