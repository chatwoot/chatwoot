...
export const isOnHelpNeededView = ({ route: { name: routeName } }) => {
  const HELP_NEEDED_ROUTES = [
    'conversation_help_needed',
    'conversation_through_help_needed',
  ];
  return HELP_NEEDED_ROUTES.includes(routeName);
};
