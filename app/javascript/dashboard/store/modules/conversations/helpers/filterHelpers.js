 ...
 *
 * @param {string|number|null|undefined} dateInput - The date value to parse
 * @returns {Date|null} - Parsed Date object, or null if input is invalid
 *
 * @example
 * parseDate('2025-06-01') // Returns Date object set to 2025-06-01 00:00:00
 * parseDate('2025-06-01T12:30:00Z') // Returns Date object with specified time
 * parseDate(1748834578) // Returns Date object (10-digit timestamp in seconds)
 * parseDate(1748834578000) // Returns Date object (13-digit timestamp in milliseconds)
 * parseDate('1748834578') // Returns Date object (string timestamp converted)
...
const matchesCondition = (conversationValue, filter) => {
  ...
  switch (filterOperator) {
    ...
    case 'is_greater_than': {
      const conversationDate = parseDate(conversationValue);
