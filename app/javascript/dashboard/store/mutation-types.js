export default {
  ...
  // AI Features - Canned Response Suggestions
  SET_CANNED_RESPONSE_SUGGESTIONS: 'SET_CANNED_RESPONSE_SUGGESTIONS',
  SET_CANNED_RESPONSE_SUGGESTIONS_LOADING: 'SET_CANNED_RESPONSE_SUGGESTIONS_LOADING',

  // AI Features - Contact Memories
  SET_CONTACT_MEMORIES: 'SET_CONTACT_MEMORIES',
  ADD_CONTACT_MEMORY: 'ADD_CONTACT_MEMORY',
  UPDATE_CONTACT_MEMORY: 'UPDATE_CONTACT_MEMORY',
  DELETE_CONTACT_MEMORY: 'DELETE_CONTACT_MEMORY',
  SET_CONTACT_MEMORIES_UI_FLAG: 'SET_CONTACT_MEMORIES_UI_FLAG',

  // AI Features - RLHF
  ADD_RLHF_FEEDBACK: 'ADD_RLHF_FEEDBACK',
};
