...
const sortMenus = [
  {
    label: t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.OPTIONS.CREATED_AT'),
    value: 'created_at',
  },
  {
    label: t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.OPTIONS.TOTAL'),
    value: 'total',
  },
  {
    label: t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.OPTIONS.CONTACT_NAME'),
    value: 'contact_name',
  },
];
...
const orderingMenus = [
  {
    label: t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.OPTIONS.ASCENDING'),
    value: '',
  },
  {
    label: t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.OPTIONS.DESCENDING'),
    value: '-',
  },
];
...
const activeSortLabel = computed(() => {
  ...
  return (
    selectedMenu?.label || t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.LABEL')
  );
});
...
const activeOrderingLabel = computed(() => {
  ...
  return (
    selectedMenu?.label || t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.LABEL')
  );
});
    ...
    >
      <div class="flex items-center justify-between gap-2">
        <span class="text-sm text-n-slate-12">
          {{ t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.LABEL') }}
        </span>
        <SelectMenu
      ...
      <div class="flex items-center justify-between gap-2">
        <span class="text-sm text-n-slate-12">
          {{ t('CARTS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.LABEL') }}
        </span>
        <SelectMenu
