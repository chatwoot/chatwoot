export const WHATSAPP_CAMPAIGN_EMPTY_STATE_CONTENT = [
  ...
  },
  {
    ...
    message: 'Announcement Template',
    campaign_status: 'completed',
    enabled: true,
    campaign_type: 'whatsapp',
    scheduled_at: 1329776588,
    trigger_rules: {},
    trigger_only_during_business_hours: false,
    created_at: '2024-10-24T13:13:08.496Z',
    updated_at: '2024-10-24T13:15:38.698Z',
...
export const EMAIL_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    id: 1,
    title: 'PaperLayer Newsletter',
    inbox: {
      id: 6,
      name: 'PaperLayer Email',
      channel_type: 'Channel::Email',
      phone_number: 'paperlayer@gmail.com',
      provider: 'default',
    },
    message:
      '<p>Hello! Enjoying our product? Share your feedback on G2 and earn a $25 Amazon coupon: https://chwt.app/g2-review</p>',
    campaign_status: 'active',
    enabled: true,
    campaign_type: 'email',
    scheduled_at: 1729775588,
  ...
  {
    id: 2,
    title: 'PaperLayer Release Announcement',
    inbox: {
      id: 6,
      name: 'PaperLayer Email',
      channel_type: 'Channel::Email',
    ...
    message:
      '<p>Hello! We are excited to announce the release of our new product. Please check it out and let us know what you think.</p>',
    campaign_status: 'active',
    enabled: true,
    campaign_type: 'email',
    scheduled_at: 1729775588,
