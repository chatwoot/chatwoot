...
<template>
  <li
    ...
    class="flex w-full justify-end mb-2 ps-8 pe-8 message--read"
    data-clarity-mask="True"
  >
    <div
      class="max-w-lg min-w-0 rounded-xl border border-n-weak bg-n-alpha-2 px-4 py-3 text-sm"
    >
      <div
        class="flex items-center gap-1.5 text-xs font-medium text-n-slate-11 mb-1.5"
      >
        <Icon
        ...
        <RouterLink
          ...
          "
          class="min-w-0 break-words text-inherit hover:underline focus-visible:underline"
        >
      ...
      <div
        class="flex flex-wrap items-center justify-end gap-1.5 mt-1 text-xs text-n-slate-11"
      >
        <time
