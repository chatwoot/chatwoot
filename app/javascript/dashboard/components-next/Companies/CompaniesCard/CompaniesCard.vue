      ...
      <div class="flex flex-col gap-0.5 flex-1 min-w-0">
        <div class="flex flex-wrap items-center gap-x-4 gap-y-1 min-w-0">
          ...
          <span
            ...
            class="inline-flex items-center gap-1.5 text-sm text-s-muted truncate"
          >
            <Icon icon="i-lucide-globe" size="size-3.5 text-s-muted" />
        ...
        <div class="flex items-center justify-between">
          <div class="flex flex-wrap items-center gap-x-3 gap-y-1 min-w-0">
            ...
            <span v-if="description" class="text-sm text-s-muted truncate">
              {{ description }}
            </span>
            <div
            ...
            <span
              ...
              class="inline-flex items-center gap-1.5 text-sm text-s-muted truncate"
            >
              <Icon icon="i-lucide-contact" size="size-3.5 text-s-muted" />
              {{ t('COMPANIES.CONTACTS_COUNT', { n: contactsCount }) }}
            </span>
          </div>
          <span
            v-if="updatedAt"
            class="inline-flex items-center gap-1.5 text-sm text-s-muted flex-shrink-0"
          >
            {{ formattedUpdatedAt }}
          </span>
        </div>
