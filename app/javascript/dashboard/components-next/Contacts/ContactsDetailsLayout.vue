...
<template>
  <section
    class="flex w-full h-full overflow-hidden justify-evenly bg-s-surface"
  >
    <div
    ...
    <div
      v-if="slots.sidebar"
      class="hidden lg:block overflow-y-auto justify-end min-w-52 w-full py-6 max-w-md border-l border-s-border bg-s-subtle"
    >
      <slot name="sidebar" />
    </div>
    ...
    >
      ...
      <div
        ...
        class="flex items-start p-1 w-fit h-fit relative order-1 xs:top-24 top-28 transition-all bg-s-subtle border border-s-border duration-500 ease-in-out"
        :class="[
      ...
      >
        <Button
          ...
          :class="{ 'bg-s-subtle': isContactSidebarOpen }"
          :icon="
            isContactSidebarOpen
      ...
      >
        <div
          ...
          class="order-2 w-[85%] sm:w-[50%] bg-s-subtle ltr:border-l rtl:border-r border-s-border overflow-y-auto py-6 shadow-lg"
        >
          <slot name="sidebar" />
        </div>
      </Transition>
