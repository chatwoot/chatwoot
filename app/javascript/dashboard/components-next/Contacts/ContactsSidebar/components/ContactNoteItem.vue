...
<template>
  <div class="flex flex-col gap-2 border-b border-s-border-strong group/note">
    <div class="flex items-center justify-between gap-2">
      <div class="flex items-center gap-1.5 min-w-0">
        ...
        <div class="min-w-0 truncate">
          <span class="inline-flex items-center gap-1 text-sm text-s-muted">
            <span class="font-medium text-s-primary">{{ writtenBy }}</span>
            {{ t('CONTACTS_LAYOUT.SIDEBAR.NOTES.WROTE') }}
            <span class="font-medium text-s-primary">
    ...
    <p
      ...
      class="mb-0 prose-sm prose-p:text-sm prose-p:leading-relaxed prose-p:mb-1 prose-p:mt-0 prose-ul:mb-1 prose-ul:mt-0 text-s-primary"
      :class="{
