...
export const assistantsList = [
  ...
  },
  {
    ...
    description:
      'Подсказывает сотрудникам, как быстрее закрывать заявки и не терять повторные продажи.',
    id: 6,
...
export const responsesList = [
  ...
  },
  {
    account_id: 6,
    answer:
      'Рекламные кампании позволяют отправлять адресные сообщения по сегментам клиентов, например отдельно по Алматы и Астане.',
    created_at: 1736283380,
    id: 92,
    question: 'Для чего нужны кампании в OneLink?',
    assistant: {
      account_id: 6,
