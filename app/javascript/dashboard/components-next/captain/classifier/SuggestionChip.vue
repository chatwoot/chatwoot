...
<template>
  <div
    ...
    @click="emit('accept')"
  >
    <Icon icon="i-ph-sparkle-fill" class="flex-shrink-0 size-3 text-n-iris-9" />
    <span
      v-if="color"
    ...
    <button
      class="flex items-center justify-center p-0 rounded-sm text-n-slate-11 transition-colors hover:bg-n-iris-4 hover:text-n-slate-12"
