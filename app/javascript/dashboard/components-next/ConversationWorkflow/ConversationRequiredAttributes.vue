...
const { t } = useI18n();
const { currentAccount, accountId, isOnDaxowCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnDaxowCloud.value);
const i18nKey = computed(() =>
  isOnDaxowCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
