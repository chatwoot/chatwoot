...
<template>
  <CardLayout>
    <div class="flex justify-between w-full gap-1">
      <span
        class="text-base cursor-pointer hover:underline underline-offset-2 hover:text-s-brand-text text-s-primary line-clamp-1"
      ...
      <div class="flex items-center gap-2">
        <span
          class="text-xs font-medium inline-flex items-center h-6 px-2 py-0.5 rounded-md bg-s-subtle"
    ...
    <div class="flex items-center justify-between w-full gap-4">
      <div class="flex items-center gap-4">
        ...
        <span class="block text-sm whitespace-nowrap text-s-muted">
          {{ categoryName }}
        </span>
        <div
          class="inline-flex items-center gap-1 text-s-muted whitespace-nowrap"
        >
      ...
      <span class="text-sm text-s-muted line-clamp-1">
        {{ lastUpdatedAt }}
      </span>
    </div>
  </CardLayout>
