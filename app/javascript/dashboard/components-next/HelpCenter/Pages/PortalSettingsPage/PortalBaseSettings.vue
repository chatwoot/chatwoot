...
<template>
  <div class="flex flex-col w-full gap-4">
    ...
    <div class="flex flex-col w-full gap-4">
      ...
      >
        <label
          class="text-sm font-medium whitespace-nowrap py-2.5 text-s-primary"
        >
      ...
      >
        <label
          class="text-sm font-medium whitespace-nowrap text-s-primary py-2.5"
        >
      ...
      >
        ...
        <ComboBox
          ...
          "
          class="[&>div>button:not(.focused)]:!outline-s-border"
        />
      </div>
      <div
        class="grid items-start justify-between w-full gap-2 grid-cols-[200px,1fr]"
