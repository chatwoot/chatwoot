      ...
      <OnClickOutside @trigger="openAgentsList = false">
        ...
        >
          <Avatar
            ...
            rounded-full
          />
          <span class="text-sm text-s-primary hover:text-s-muted">
            {{ authorName || '-' }}
          </span>
        </Button>
        <DropdownMenu
      ...
      <OnClickOutside @trigger="openCategoryList = false">
        ...
        >
          <span
            ...
            class="text-sm text-s-primary hover:text-s-muted"
          >
            {{
    ...
    <div class="relative">
      <OnClickOutside @trigger="openProperties = false">
        <Button
          ...
          class="!px-2 font-normal hover:!bg-transparent hover:!text-s-muted"
