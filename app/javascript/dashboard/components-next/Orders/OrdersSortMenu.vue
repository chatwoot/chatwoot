...
const sortMenus = [
  {
    label: t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.OPTIONS.CREATED_AT'),
    value: 'created_at',
  },
  {
    label: t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.OPTIONS.TOTAL'),
    value: 'total',
  },
  {
    label: t(
      'ORDERS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.OPTIONS.CONTACT_NAME'
    ),
    value: 'contact_name',
  },
];
...
const orderingMenus = [
  {
    label: t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.OPTIONS.ASCENDING'),
    value: '',
  },
  {
    label: t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.OPTIONS.DESCENDING'),
    value: '-',
  },
];
...
const activeSortLabel = computed(() => {
  ...
  return (
    selectedMenu?.label ||
    t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.SORT_BY.LABEL')
  );
});
...
const activeOrderingLabel = computed(() => {
  ...
  return (
    selectedMenu?.label || t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.LABEL')
  );
});
...
<template>
  <div class="relative">
    ...
    >
      ...
      <div class="flex items-center justify-between gap-2">
        <span class="text-sm text-n-slate-12">
          {{ t('ORDERS_LIST.HEADER_CONTROLS.ACTIONS.ORDER.LABEL') }}
        </span>
        <SelectMenu
