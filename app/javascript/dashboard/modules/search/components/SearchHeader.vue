...
<template>
  ...
  >
    ...
    <input
      ref="searchInput"
      type="search"
      class="w-full !mb-0 !outline-none !bg-transparent !shadow-none text-n-slate-12 dark:text-n-slate-12 active:border-transparent active:shadow-none hover:border-transparent hover:shadow-none focus:border-transparent focus:shadow-none"
