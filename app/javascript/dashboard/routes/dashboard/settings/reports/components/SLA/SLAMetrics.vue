...
<template>
  <div
    class="flex sm:flex-row flex-col w-full gap-4 sm:gap-20 shadow outline-1 outline outline-n-container rounded-xl bg-n-solid-2 px-10 py-8 overflow-hidden"
  >
    <SLAMetricCard
