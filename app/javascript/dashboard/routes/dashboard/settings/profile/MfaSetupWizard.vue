      ...
      >
        ...
        <div class="flex justify-center">
          ...
          >
            ...
            <div
              v-else
              class="w-48 h-48 flex items-center justify-center bg-s-subtle dark:bg-s-subtle"
            >
        ...
        <details class="border border-s-border-subtle rounded-lg">
          <summary
            class="px-4 py-3 cursor-pointer hover:bg-s-subtle dark:hover:bg-s-subtle text-sm font-medium text-s-muted"
          >
            {{ $t('MFA_SETTINGS.SETUP.MANUAL_ENTRY') }}
          </summary>
          <div class="px-4 pb-4">
            <label class="block text-xs text-s-muted mb-2">
    ...
    <div v-if="setupStep === 'backup'" class="space-y-6">
      ...
      >
        <Icon
          ...
          class="size-4 text-s-muted flex-shrink-0 mt-0.5"
        />
        <p class="text-sm text-s-muted">
      ...
      >
        <div class="grid grid-cols-2 xs:grid-cols-4 sm:grid-cols-5 gap-3">
          <span
            ...
            :key="index"
            class="px-1 py-2 font-mono text-base text-center text-s-primary"
          >
            {{ code }}
          </span>
        </div>
      ...
      <div class="space-y-4">
        <label class="flex items-start gap-3">
          <input
            ...
            type="checkbox"
            class="mt-1 rounded border-s-border-subtle text-s-brand focus:ring-s-brand"
          />
