...
<template>
  <div>
    <label class="pb-1 text-sm font-medium leading-6 text-on-surface">
      {{ label }}
    </label>
    <div class="grid gap-3 mt-2">
      ...
      >
        ...
        <label
          ...
          class="text-sm text-on-surface font-normal"
        >
          {{
            $t(
      ...
      <div class="text-on-surface-variant text-sm font-medium mt-2">
        {{ $t(alertDescription) }}
      </div>
    </div>
  </div>
