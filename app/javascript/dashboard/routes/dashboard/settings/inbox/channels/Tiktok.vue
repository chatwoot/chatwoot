  ...
  <div class="h-full p-6 w-full max-w-full flex-shrink-0 flex-grow-0">
    <div class="flex flex-col items-center justify-start h-full text-center">
      ...
      >
        ...
        <button
          class="flex items-center justify-center px-8 py-3.5 gap-2 text-white rounded-full bg-gradient-to-r from-[#00f2ea] via-[#ff0050] to-[#000000] hover:shadow-lg transition-all duration-300 min-w-[240px] overflow-hidden"
