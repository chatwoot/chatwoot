...
<template>
  <div class="mx-auto flex flex-col gap-6 mb-8 max-w-7xl w-full !px-6">
    ...
    <div
      class="grid grid-cols-1 lg:grid-cols-8 lg:divide-x lg:divide-n-weak rounded-xl border border-n-weak min-h-0 h-full lg:h-auto xl:min-h-[35rem] 2xl:min-h-[52rem]"
    >
      <woot-wizard
