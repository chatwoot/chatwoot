...
import XReauthorize from './channels/x/Reauthorize.vue';
...
export default {
  ...
  computed: {
    ...
    xUnauthorized() {
      return this.isAXChannel && this.inbox.reauthorization_required;
    },
...
<template>
  ...
  >
    ...
    <section class="mx-auto w-full max-w-6xl">
      ...
      <XReauthorize v-if="xUnauthorized" :inbox="inbox" />
      <WhatsappReauthorize
