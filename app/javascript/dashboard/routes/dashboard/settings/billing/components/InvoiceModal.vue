    ...
    <div class="flex flex-row gap-3">
        <div class="bg-n-alpha-3 shadow-md modal-container rounded-xl">
            <div class="flex items-center justify-center mt-5">
                <span class="text-[#2C4D3D] dark:text-[#2F9428] font-bold text-xl">{{ $t('BILLING.INVOICE.TITLE') }}</span>
            </div>
            ...
            <div class="p-5 flex flex-col gap-4">
                ...
                <div class="text-sm">
                    <div class="rounded-lg bg-[#E9F5EC] flex flex-row w-full p-4">
                        <div class="flex-1 flex flex-col gap-3">
                            ...
                            <div class="flex flex-col gap-1 dark:text-[#000]">
                ...
                <div class="flex flex-col gap-2">
                    <div>
                        <span class="font-bold text-[#2C4D3D] dark:text-[#2F9428]">{{ $t('BILLING.INVOICE.DETAIL_PAYMENT') }}</span>
                    </div>
                    <div class="flex flex-row gap-3">
                ...
                <div class="flex flex-row justify-end">
                    <div class="flex flex-row gap-6">
                        ...
                        <span class="text-[#2C4D3D] dark:text-[#2F9428] font-bold">{{ new Intl.NumberFormat(locale ||
                            'id').format(props.data.price) }}</span>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-n-alpha-3 shadow-md modal-container rounded-xl h-[min-content] w-[275px]">
            <div class="flex mx-5 mt-5">
                <span class="text-[#2C4D3D] dark:text-[#2F9428] font-bold">{{ $t('BILLING.INVOICE.PAYMENT_METHOD') }}</span>
            </div>
            ...
            <div class="p-5 flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex flex-row gap-1 items-center">
                        <span class="text-[#2C4D3D] dark:text-[#2F9428] text-lg font-bold">{{ new Intl.NumberFormat(locale
                            ||
                            'id').format(props.data.price) }}</span>
