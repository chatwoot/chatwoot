...
<template>
  <div
    class="px-6 py-4 mb-4 outline outline-outline-variant/15 outline-1 bg-surface-container-lowest rounded-md shadow"
  >
    <div class="flex">
      ...
      <div class="ml-3">
        <p class="mb-1 text-base font-semibold text-on-surface">
          {{
            $t('INTEGRATION_SETTINGS.SLACK.SELECT_CHANNEL.ATTENTION_REQUIRED')
          }}
        </p>
        <div class="mt-2 text-sm text-on-surface-variant mb-3">
