  ...
  <div class="space-y-4">
    <div>
      ...
      <p class="text-xs text-n-slate-10 mt-1">
        ...
        <code class="px-1 bg-n-slate-2 rounded">&lbrace;&lbrace;parameter_name&rbrace;&rbrace;</code>
      </p>
    </div>
    ...
    <div v-if="parametersList.length > 0" class="bg-n-slate-2 rounded-lg p-4">
      <div class="text-xs font-medium text-n-slate-11 mb-2">
        Available Parameters (click to insert):
      </div>
      <div class="flex flex-wrap gap-2">
        ...
        >
          &lbrace;&lbrace;{{ param.name }}&rbrace;&rbrace;
        </button>
      </div>
    </div>
  </div>
