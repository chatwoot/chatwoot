    ...
    <div class="flex justify-between w-full px-4 py-2">
      ...
      <div class="flex gap-2">
        ...
        >
          ...
          <input
            type="text"
            :placeholder="$t('ORDERS_PAGE.SEARCH_INPUT_PLACEHOLDER')"
            class="order-search border-slate-100 dark:border-slate-600"
            :value="searchQuery"
        ...
        <div v-if="hasActiveSegments" class="flex gap-2">
          ...
          >
            {{ $t('ORDERS_PAGE.FILTER_ORDERS_EDIT') }}
          </woot-button>
          <woot-button
            class="clear"
            color-scheme="alert"
          ...
          >
            {{ $t('ORDERS_PAGE.FILTER_ORDERS_DELETE') }}
          </woot-button>
        </div>
        ...
        >
          {{ $t('ORDERS_PAGE.FILTER_ORDERS_SAVE') }}
        </woot-button>
        <woot-button
          class="clear"
