<template>
  <div
    class="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-300 border-slate-50 dark:border-slate-800/50 ltr:border-l contact--panel overflow-y-auto"
  >
    <contact-info
      :contact="contact"
