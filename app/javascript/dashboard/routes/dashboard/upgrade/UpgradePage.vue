...
<template>
  ...
  >
    <div
      class="flex flex-col gap-4 max-w-md px-8 py-6 shadow-lg bg-s-surface rounded-xl outline outline-1 outline-s-border"
    >
      <div class="flex flex-col gap-4">
        ...
        <div>
          <p class="text-sm font-normal text-s-muted mb-3">
