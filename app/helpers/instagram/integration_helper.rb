module Instagram::IntegrationHelper
  ...
  def generate_instagram_token(account_id, return_to = nil)
    ...
    generate_oauth_state_token('Instagram', client_secret, token_payload(account_id, return_to))
  end
  ...
  def verify_instagram_token(token)
    ...
    decode_oauth_state_token('Instagram', token, client_secret)&.dig('sub')
  end
  ...
  def instagram_token_return_to(token)
    ...
    decode_oauth_state_token('Instagram', token, client_secret)&.dig('return_to')
  end
