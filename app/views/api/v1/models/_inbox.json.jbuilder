...
if resource.email?
  ...
  json.imap_password resource.channel.try(:imap_password) if Current.account_user&.administrator?
  ...
  json.smtp_password resource.channel.try(:smtp_password) if Current.account_user&.administrator?
