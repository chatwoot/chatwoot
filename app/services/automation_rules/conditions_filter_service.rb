...
class AutomationRules::ConditionsFilterService < FilterService
  ...
  def conversation_query_string(table_name, current_filter, query_hash, current_index)
    ...
    return label_condition_query(query_hash, current_index) if attribute_key == 'labels'
  ...
  def label_condition_query(query_hash, current_index)
    AutomationRules::LabelsConditionBuilder.new(
