...
class Telegram::IncomingMessageService
  ...
  def additional_attributes
    {
      # TODO: Remove this once we show the telegram_user_name in the UI instead of the username
      username: telegram_params_username,
      language_code: telegram_params_language_code,
      telegram_user_id: telegram_params_from_id,
      telegram_user_name: telegram_params_username
    }
  end
