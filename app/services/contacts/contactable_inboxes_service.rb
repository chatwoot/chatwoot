class Contacts::ContactableInboxesService
  ...
  def get_contactable_inbox(inbox)
    return website_contactable_inbox(inbox) if inbox.web_widget?
    return api_contactable_inbox(inbox) if inbox.api?

    { source_id: inbox.channel.source_id_for(@contact), inbox: inbox }
  rescue Channel::Base::Unsupported, ActionController::ParameterMissing
    nil
  end
