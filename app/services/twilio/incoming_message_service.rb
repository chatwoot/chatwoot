class Twilio::IncomingMessageService
  ...
  def twilio_channel
    ...
    # Phone number will change based on the message type, if the message is already present, we will use the from number
    # TODO: Handle this in a better way, use @message
    phone_number = message.present? ? params[:From] : params[:To]
