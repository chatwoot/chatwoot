class CustomFeaturesManagerService
  ...
  def get_custom_features(account)
    begin
      ...
      valid_features = stored_features.select do |feature|
        CustomFeaturesService.feature_exists?(feature)
      end
  ...
  def set_custom_features(account, features)
    begin
      ...
      available_custom_features = CustomFeaturesService.feature_names
  ...
  def all_custom_features
    begin
      CustomFeaturesService.feature_names
    rescue StandardError => e
  ...
  def feature_display_names
    begin
      CustomFeaturesService.display_names_map
    rescue StandardError => e
  ...
  def features_with_metadata
    begin
      CustomFeaturesService.all_features
    rescue StandardError => e
