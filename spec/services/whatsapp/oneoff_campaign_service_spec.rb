  ...
  describe '#perform' do
    ...
    context 'when campaign validation fails' do
      ...
      it 'raises error when campaign is not oneoff' do
        ...
        expect { whatsapp_campaign_service.perform }.to raise_error "Invalid campaign #{campaign.id}"
      end
    ...
    context 'when send_template raises an error' do
      it 'logs error and re-raises' do
        ...
        expect { whatsapp_campaign_service.perform }.to raise_error(StandardError, error_message)
      end
    end
  end
end