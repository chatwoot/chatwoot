...
describe Whatsapp::Providers::WhatsappCloudService do
  ...
  before do
    stub_request(:get, 'https://graph.facebook.com/v19.0/123456789/message_templates?access_token=test_key')
  end

  describe '#send_message' do
    context 'when called' do
      it 'calls message endpoints for normal messages' do
        stub_request(:post, 'https://graph.facebook.com/v19.0/123456789/messages')
          .with(
            body: {
        ...
        stub_request(:get, 'https://graph.facebook.com/v19.0/123456789/message_templates?access_token=test_key')
          .to_return(
            { status: 200, headers: response_headers,
              ...
              ], paging: { next: 'https://graph.facebook.com/v19.0/123456789/message_templates?access_token=test_key' } }.to_json },
            { status: 200, headers: response_headers,
              body: { data: [
            ...
            { status: 200, headers: response_headers,
              ...
              ], paging: { prev: 'https://graph.facebook.com/v19.0/123456789/message_templates?access_token=test_key' } }.to_json }
          )
  ...
  describe '#validate_provider_config' do
    context 'when called' do
      ...
      it 'returns false if invalid' do
        stub_request(:get, 'https://graph.facebook.com/v19.0/123456789/message_templates?access_token=test_key').to_return(status: 401)
