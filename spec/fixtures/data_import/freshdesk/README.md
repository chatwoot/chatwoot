...
These fixtures are synthetic and contain no production credentials, signed
attachment URLs, or personal data. Their field shapes were derived from the
Freshdesk API v2 documentation and sanitized examples in these public
repositories:
