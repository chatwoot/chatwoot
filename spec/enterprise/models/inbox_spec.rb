...
RSpec.describe Inbox do
  ...
  describe 'validations' do
    describe 'account inbox limit' do
      ...
      it 'prevents creating inboxes beyond the account limit' do
        new_inbox = build(:inbox, account: account)

        expect(new_inbox).not_to be_valid
        expect(new_inbox.errors[:base]).to include('Account limit exceeded. Upgrade to a higher plan')
      end
