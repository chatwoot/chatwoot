...
RSpec.describe MonitorSlaJob do
  context 'when perform is called' do
    let(:applied_sla1) { create(:applied_sla, sla_status: 'active') }
    let(:applied_sla2) { create(:applied_sla, sla_status: 'active') }
  ...
  context 'when MonitorSlaJob is performed' do
  ...
  context 'when MonitorSlaJob is performed with a conversation having first reply' do
  ...
  context 'when MonitorSlaJob is performed with conversation that is resolved' do
  ...
  context 'when MonitorSlaJob is performed with conversation that is resolve' do
    let!(:conversation) { create(:conversation, created_at: 6.hours.ago, updated_at: 3.hours.ago) }
