...
RSpec.describe Account do
  it { is_expected.to validate_numericality_of(:auto_resolve_duration).is_greater_than_or_equal_to(15) }
  it { is_expected.to validate_numericality_of(:auto_resolve_duration).is_less_than_or_equal_to(1_439_856) }
