...
RSpec.describe Account do
  it { is_expected.to validate_numericality_of(:auto_resolve_duration).is_greater_than_or_equal_to(Limits::AUTO_RESOLVE_DURATION_MIN_MINUTES) }
  it { is_expected.to validate_numericality_of(:auto_resolve_duration).is_less_than_or_equal_to(Limits::AUTO_RESOLVE_DURATION_MAX_MINUTES) }
