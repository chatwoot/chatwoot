...
RSpec.describe Instagram::CallbacksController do
  ...
  before do
    ...
    stub_request(:post, 'https://graph.instagram.com/v22.0/12345/subscribed_apps?access_token=long_lived_test_token&subscribed_fields%5B%5D=messages&subscribed_fields%5B%5D=message_reactions&subscribed_fields%5B%5D=messaging_seen&subscribed_fields%5B%5D=messaging_postbacks')
      .with(
        headers: {
          'Accept' => '*/*',
