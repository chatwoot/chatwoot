...
RSpec.describe 'Platform Agent Bot API', type: :request do
  ...
  describe 'GET /platform/api/v1/agent_bots' do
    ...
    context 'when it is an invalid platform app token' do
      it 'returns unauthorized' do
        get '/platform/api/v1/agent_bots', headers: { 'api-access-token': 'invalid' }, as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
    ...
    context 'when it is an authenticated platform app' do
      ...
      it 'returns unauthorized when its not a permissible object' do
        get '/platform/api/v1/agent_bots', headers: { 'api-access-token': platform_app.access_token.token }, as: :json
  ...
  describe 'GET /platform/api/v1/agent_bots/{agent_bot_id}' do
    ...
    context 'when it is an invalid platform app token' do
      it 'returns unauthorized' do
        get "/platform/api/v1/agent_bots/#{agent_bot.id}", headers: { 'api-access-token': 'invalid' }, as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
    ...
    context 'when it is an authenticated platform app' do
      ...
      it 'returns unauthorized when its not a permissible object' do
        get "/platform/api/v1/agent_bots/#{agent_bot.id}", headers: { 'api-access-token': platform_app.access_token.token }, as: :json
        expect(response).to have_http_status(:unauthorized)
      end
  ...
  describe 'POST /platform/api/v1/agent_bots/' do
    ...
    context 'when it is an invalid platform app token' do
      it 'returns unauthorized' do
        post '/platform/api/v1/agent_bots/', headers: { 'api-access-token': 'invalid' }, as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
  ...
  describe 'PATCH /platform/api/v1/agent_bots/{agent_bot_id}' do
    ...
    context 'when it is an invalid platform app token' do
      it 'returns unauthorized' do
        patch "/platform/api/v1/agent_bots/#{agent_bot.id}", headers: { 'api-access-token': 'invalid' }, as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
  ...
  describe 'DELETE /platform/api/v1/agent_bots/{agent_bot_id}' do
    context 'when it is an unauthenticated platform app' do
      it 'returns unauthorized' do
        delete "/platform/api/v1/agent_bots/#{agent_bot.id}", headers: { 'api-access-token': 'invalid' }, as: :json
        expect(response).to have_http_status(:unauthorized)
      end
    end
    ...
    context 'when it is an authenticated platform app' do
      ...
      it 'returns deletes the account user' do
        ...
        delete "/platform/api/v1/agent_bots/#{agent_bot.id}", headers: { 'api-access-token': platform_app.access_token.token }, as: :json
