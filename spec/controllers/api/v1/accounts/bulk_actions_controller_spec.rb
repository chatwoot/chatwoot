...
RSpec.describe 'Api::V1::Accounts::BulkActionsController', type: :request do
  ...
  describe 'POST /api/v1/accounts/{account.id}/bulk_action' do
    ...
    context 'when it is an authenticated user' do
      ...
      it 'Bulk update conversation labelsd' do
        ...
        expect(Conversation.first.label_list).to eq(["support", "priority_customer"])
        expect(Conversation.second.label_list).to eq(["support", "priority_customer"])
      end
    end
  end
end
