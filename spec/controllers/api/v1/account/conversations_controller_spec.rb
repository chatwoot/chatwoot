...
RSpec.describe 'Conversations API', type: :request do
  ...
  describe 'GET /api/v1/account/{account.id}/conversations' do
  ...
  describe 'GET /api/v1/account/{account.id}/conversations/:id' do
  ...
  describe 'POST /api/v1/account/{account.id}/conversations/:id/toggle_status' do
    let(:conversation) { create(:conversation, account: account) }
  ...
  describe 'POST /api/v1/account/{account.id}/conversations/:id/update_last_seen' do
    let(:conversation) { create(:conversation, account: account) }
