...
RSpec.describe 'Canned Responses API', type: :request do
  ...
  describe 'GET /api/v1/account/{account.id}/canned_responses' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        get "/api/v1/account/#{account.id}/canned_responses"
  ...
  describe 'POST /api/v1/account/{account.id}/canned_responses' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/canned_responses"
  ...
  describe 'PUT /api/v1/account/{account.id}/canned_responses/:id' do
    let(:canned_response) { CannedResponse.last }

    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        put "/api/v1/account/#{account.id}/canned_responses/#{canned_response.id}"
  ...
  describe 'DELETE /api/v1/account/{account.id}/canned_responses/:id' do
    let(:canned_response) { CannedResponse.last }

    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        delete "/api/v1/account/#{account.id}/canned_responses/#{canned_response.id}"
