...
RSpec.describe 'Notification Settings API', type: :request do
  ...
  describe 'GET /api/v1/account/{account.id}/notification_settings' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        get "/api/v1/account/#{account.id}/notification_settings"
  ...
  describe 'PUT /api/v1/account/{account.id}/notification_settings' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        put "/api/v1/account/#{account.id}/notification_settings"
