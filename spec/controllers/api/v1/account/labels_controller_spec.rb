...
RSpec.describe 'Label API', type: :request do
  ...
  describe 'GET /api/v1/account/{account.id}/labels' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        get "/api/v1/account/#{account.id}/labels"
  ...
  describe 'GET /api/v1/account/{account.id}/labels/most_used' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        get "/api/v1/account/#{account.id}/labels"
    ...
    context 'when it is an authenticated user' do
      ...
      it 'returns most used labels' do
        get "/api/v1/account/#{account.id}/labels/most_used",
            headers: agent.create_new_auth_token,
            params: { count: 1 },
            as: :json
