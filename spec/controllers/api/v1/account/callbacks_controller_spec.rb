...
RSpec.describe 'Callbacks API', type: :request do
  ...
  describe 'POST /api/v1/account/{account.id}/callbacks/register_facebook_page' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/callbacks/register_facebook_page"
  ...
  describe 'POST /api/v1/account/{account.id}/callbacks/facebook_pages' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/callbacks/facebook_pages"
  ...
  describe 'POST /api/v1/account/{account.id}/callbacks/reauthorize_page' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/callbacks/reauthorize_page"
