...
RSpec.describe 'Facebook Indicators API', type: :request do
  ...
  describe 'POST /api/v1/account/{account.id}/facebook_indicators/mark_seen' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/facebook_indicators/mark_seen"
  ...
  describe 'POST /api/v1/account/{account.id}/facebook_indicators/typing_on' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/facebook_indicators/typing_on"
  ...
  describe 'POST /api/v1/account/{account.id}/facebook_indicators/typing_off' do
    context 'when it is an unauthenticated user' do
      it 'returns unauthorized' do
        post "/api/v1/account/#{account.id}/facebook_indicators/typing_off"
