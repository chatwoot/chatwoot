...
3. جدول فازها در `PLANNING.md §7`؛ اگر فاز قبلی ناتمام است همان را تمام کن. **وضعیت فعلی: P0✅ P1✅ P2✅ P3✅ P4🔶 (release-ready) — فاز بعدی: P4 تکمیلی (RAG, copilot depth, widget AI toggle) → P5 (Desktop Pet/Tauri).**
...
- هر فاز که تمام شد چک‌لیست §7 PLANNING.md را تیک بزن
