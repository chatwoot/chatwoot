...
- Enforce mutually exclusive bot or provider behavior at the earliest shared trigger. Do not repeat backup guards across downstream jobs, callbacks, tools, or writes unless a proven independent entry path bypasses that trigger.
