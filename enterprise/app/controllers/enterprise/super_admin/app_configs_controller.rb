module Enterprise::SuperAdmin::AppConfigsController
  ...
  def internal_config_options
    configs = %w[CHATWOOT_INBOX_TOKEN CHATWOOT_INBOX_HMAC_KEY CLOUD_ANALYTICS_TOKEN CLEARBIT_API_KEY CONTEXT_DEV_API_KEY DASHBOARD_SCRIPTS
    ...
    configs.insert(configs.index('ACCOUNT_SECURITY_NOTIFICATION_WEBHOOK_URL'), 'MARKETING_CONVERSION_TRACKING_CONFIG') if ChatwootApp.chatwoot_cloud?
    configs
  end
