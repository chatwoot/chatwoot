class Twilio::VoiceController < ApplicationController
  ...
  def call_twiml
    ...
    should_play_greeting = !agent_leg && conversation.additional_attributes&.dig('call_direction') != 'outbound'
    response.say(message: 'Please wait while we connect you to an agent') if should_play_greeting
