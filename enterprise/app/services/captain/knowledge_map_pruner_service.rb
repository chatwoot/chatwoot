class Captain::KnowledgeMapPrunerService
  ...
  def ranked_topic_names
    ...
    scores = search_index['topics'].filter_map do |topic|
      ...
      score += topic_score(previous_document, topic) * HISTORY_WEIGHT if use_previous_user_message?
  ...
  def search_index_cache_key
    "captain/knowledge-map-pruner/v2/#{@assistant.cache_key_with_version}"
  end
