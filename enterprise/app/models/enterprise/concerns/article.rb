module Enterprise::Concerns::Article
  ...
  included do
    ...
    def self.add_search_emebedding_related_associations
      has_many :article_embeddings, dependent: :destroy_async
    end

    add_search_embedding_related_associations if Features::HelpcenterEmbeddingSearchService.featuture_enabled?
  end
