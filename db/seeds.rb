...
unless Rails.env.production?
  ...
  # Sample data removed - developers can create accounts through the UI
  # This keeps the development environment clean and focused

  # Commented out sample data creation - can be re-enabled if needed for development
