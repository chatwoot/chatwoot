...
ActiveRecord::Schema.define(version: 20_211_221_125_545) do
  ...
  create_table 'channel_twilio_sms', force: :cascade do |t|
    ...
    t.index %w[account_id phone_number], name: 'index_channel_twilio_sms_on_account_id_and_phone_number', unique: true
  end
