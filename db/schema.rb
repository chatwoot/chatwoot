...
ActiveRecord::Schema.define(version: 2021_05_13_143021) do
  ...
  create_table "report_events", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_report_events_on_account_id"
    t.index ["created_at"], name: "index_report_events_on_created_at"
    t.index ["inbox_id"], name: "index_report_events_on_inbox_id"
    t.index ["name"], name: "index_report_events_on_name"
    t.index ["user_id"], name: "index_report_events_on_user_id"
  end
