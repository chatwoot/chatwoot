...
ActiveRecord::Schema[7.0].define(version: 2025_03_30_151514) do
  ...
  create_table "messages", id: :serial, force: :cascade do |t|
    ...
    t.index ["account_id", "conversation_id", "created_at"], name: "idx_messages_on_acct_conv_created_at", order: { created_at: :desc }
    t.index ["account_id", "created_at", "message_type"], name: "index_messages_on_account_created_type"
    t.index ["account_id", "inbox_id", "created_at"], name: "index_messages_account_id_inbox_id_created_at", order: { created_at: :desc }
    ...
    t.index ["conversation_id", "created_at"], name: "idx_messages_conversation_created", order: { created_at: :desc }
