...
ActiveRecord::Schema[7.1].define(version: 2025_06_20_003252) do
  ...
  create_table "application_configs", force: :cascade do |t|
    ...
    t.index ["account_id", "name"], name: "index_application_configs_on_account_id_and_name", unique: true
    t.index ["account_id", "status"], name: "index_application_configs_on_account_id_and_status"
    t.index ["account_id"], name: "index_application_configs_on_account_id"
    t.index ["last_used_at"], name: "index_application_configs_on_last_used_at"
    t.index ["user_id"], name: "index_application_configs_on_user_id"
  end
  ...
  create_table "applications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "name"], name: "index_applications_on_account_id_and_name", unique: true
  ...
  add_foreign_key "application_configs", "accounts"
  add_foreign_key "application_configs", "users"
