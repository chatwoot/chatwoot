...
ActiveRecord::Schema[7.1].define(version: 2025_12_30_081904) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "booking_emails", default: []
  ...
  create_table "channel_facebook_pages", id: :serial, force: :cascade do |t|
    ...
    t.text "user_access_token", null: false
    t.text "page_access_token", null: false
    t.integer "account_id", null: false
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.string "follow_up_jid"
    t.boolean "stop_follow_up", default: false
    t.bigint "assignee_agent_bot_id"
    t.text "summary"
    t.datetime "summary_updated_at"
    t.datetime "conversation_summary_last_generated_at"
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.index ["phone_number"], name: "index_users_on_phone_number", unique: true, where: "((phone_number IS NOT NULL) AND ((phone_number)::text <> ''::text))"
